% This is an example file on how the MSWL program [1] could be used.

% [1] Jia Zhang, Shaozi Li, Min Jiang, Kay Chen Tan. Learning from Weakly Labeled Data Based on Manifold Regularized Sparse Model. IEEE Transactions on Cybernetics, 2020.
